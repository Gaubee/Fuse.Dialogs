...
namespace Fuse.Dialogs
{
	...
	public class DialogModule : NativeModule
	{
		...
		static DialogButton CreateButton(Uno.Threading.IDispatcher dispatcher, Fuse.Scripting.Object obj)
		{
			if (obj == null)
				return null;
		...
		{
			readonly Uno.Threading.IDispatcher _dispatcher;
			readonly Function _function;

			public CallbackClosure(Uno.Threading.IDispatcher dispatcher, Function function)
			{
	...
	extern(Android) internal class AndroidDialogBuilder : DialogBuilder
	{
		...
		class AndroidDialog : Dialog
		{
			...
			void Show(Java.Object handle)
			@{
				((android.app.AlertDialog)handle).show();
			@}

			[Foreign(Language.Java)]
			void Hide(Java.Object handle)
			@{
		...
		[Foreign(Language.Java)]
		void SetNegativeButton(Java.Object handle, string text, Action callback)
		@{
			final Object callbackStore = callback;
